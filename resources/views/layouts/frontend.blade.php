                    ...
                    <div class="container-fluid">
                        <div class="header-bottom-wrapper">
                            <div class="logo-2 furniture-logo ptb-30">
                                <a href="/">
                                    <img height="60" style="transform:scale(1.5);object-fit: cover; padding-left: 12px;" src="{{ asset('frontend/assets/img/logo/logoNew.png') }}" alt="">
                                </a>
                            </div>
                    ...
                    <div class="widget-wrapper">
                        ...
                        <img height="60" style="transform:scale(1.5);object-fit: cover; padding-left: 12px;" src="{{ asset('frontend/assets/img/logo/logoNew.png') }}" alt="">
                            <div class="footer-about-2">
                                <p>Temukan inovasi terkini dan pilihan lengkap <br> perangkat elektronik di Elektromart,<br> tempat terbaik untuk memenuhi kebutuhan  <br> <strong>teknologi Anda!</strong></p>
                            </div>
                        </div>
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-info-wrapper-3">
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>Jalan Jendral Wanto No 31A <br> Perum JatiImam Batang Jateng <br>IND- 10800</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                ...
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p><a href="#"> elektromart@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="copyright-furniture">
                                <p>Copyright © <a href="/">UnissProductions</a> 2090 . All Right Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
