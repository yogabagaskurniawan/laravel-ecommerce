...
@section('content')
	<div class="breadcrumb-area pt-205 breadcrumb-padding pb-210" style="background-image: url({{ asset('frontend/assets/img/bg/imgOrder.jpeg') }})">
								...
								<tbody>
									@forelse ($orders as $order)
										<tr>    
											...
											<td>{{ $order->shipment->track_number !== null ? $order->shipment->track_number : '-' }}</td>
											<td>
