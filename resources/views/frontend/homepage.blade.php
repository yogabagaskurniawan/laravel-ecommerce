                ...
                @foreach($slides as $key => $slide)
                    <div class="carousel-item {{$key == 0 ? 'active' : '' }}">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h2 class="text-white" style="text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5);font-weight: bold;">{{ $slide->title }}</h2>
                            <p>{!! $slide->body !!}</p>
                            <a class="furniture-slider-btn btn-hover animated text-white" style="border: 6px solid #fff;box-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5);" href="{{ $slide->url }}">Go</a>
                        </div>
                    </div>    
                @endforeach
            </div>
