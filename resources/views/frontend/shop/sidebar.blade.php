            ...
            @foreach($recent_reviews as $recent_review)
                <li>
                    <div class="post-wrapper d-flex">
                        <div class="mb-2">
                            <img src="https://ui-avatars.com/api/?name={{ $recent_review->user->first_name }}&background=0d8abc&color=fff" alt="{{ $recent_review->first_name }}">
                        </div>
                        <div class="ml-3 p-0">
                            @if(isset($recent_review->product->slug))
                                <p>
                                    <span class="">{{ $recent_review->user->first_name }}</span>
