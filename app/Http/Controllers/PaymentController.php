...
class PaymentController extends Controller
{
	...
	public function completed(Request $request){ 
		...
		if ($order->payment_status == Order::UNPAID) {
			return redirect()->route('payment.failed', ['order_id' => $code]);
		}
	...
	public function failed(Request $request){
		...
		return redirect()->route('orders.received', ['order_id' => $order->id]);
	}
    ...
    // }
		...
		// 		// return redirect()->route('payment.completed')->setStatusCode(308);
		// 		return redirect('text')->setStatusCode(308);
		// 	}
		// }